		...
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent">
						<input type="text" style="width:90px;" name="signingDate" value="<fmt:formatDate value="${obj.signingDate}" pattern="yyyy-MM-dd"/>" readonly
	        ...
	        <tr>
	            ...
	            <td class="tableContent">
						<input type="text" style="width:90px;" name="deliveryPeriod" value="<fmt:formatDate value="${obj.deliveryPeriod}" pattern="yyyy-MM-dd"/>" readonly
			             onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});"/>
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td class="tableContent">
						<input type="text" style="width:90px;" name="shipTime" value="<fmt:formatDate value="${obj.shipTime}" pattern="yyyy-MM-dd"/>" readonly
			             onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});"/>
	            </td>
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><textarea name="crequest" value="${obj.crequest} style="width:100%;height:120px;"></textarea></td>
	            <td class="columnTitle">说明：</td>
	            <td class="tableContent"><textarea name="remark" value="${obj.remark} style="width:100%;height:120px;"></textarea></td>
