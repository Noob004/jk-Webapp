    ...
    <div>
		<table class="commonTable" cellspacing="1">
			<tr>
	            ...
	            <td class="tableContentAuto"><input type="text" name="orderNo" value="${obj.orderNo}"/></td>
			</tr>
	        <tr>
	            ...
	            <td class="tableContent">
	            	<select name="factoryId" onchange="setFactoryName(this.options[this.selectedIndex].text)">
	            		...
	            		<c:forEach items="${factoryList}" var="f">
	            			<option value="${f.id}" <c:if test="${f.id==factoryId}">selected</c:if>>
	            			${f.factoryName}
	            			</option>
	            		</c:forEach>
	            	</select>
	            ...
	            <td class="tableContentAuto"><input type="text" name="productNo" value="${obj.productNo}"/></td>
	        </tr>		
	        <tr>
